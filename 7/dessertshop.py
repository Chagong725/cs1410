...
class Order:
    ...
    def print_order(self):
        ...
        print("_____________________________________________________")
        print("Payment with ", payment.upper())
...
def stock_freezer():
    freezer = Freezer()
    for i in range(10):
        freezer.add_2_freezer(IceCream('Vanilla Ice Cream', 3, .5))
        freezer.add_2_freezer(IceCream('Chocolate Ice Cream', 3, .5))
        freezer.add_2_freezer(IceCream('Mint Chocolate Chip Ice Cream', 3, .5))
        freezer.add_2_freezer(Cookie('Chocolate Chip Cookie', 3, 5.5))
        freezer.add_2_freezer(Cookie('Potato Chip', 3, 5.5))
        freezer.add_2_freezer(Cookie('Pretzel', 3, 5.5))
        freezer.add_2_freezer(Sundae('Vanilla Ice Cream', 3, .5, 'Sprinkles'))
        freezer.add_2_freezer(Sundae('Chocolate Ice Cream', 3, .5, 'Caramel'))
        freezer.add_2_freezer(Sundae('Mint Chocolate Chip Ice Cream', 3, .5, 'Oatmeal Raisi'))
